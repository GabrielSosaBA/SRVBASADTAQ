 ...
 */
package hn.bancatlan.srvbasa007dtaq.util;

import hn.bancatlan.srvbasa007dtaq.dtaq.Dtaq;
...
public class Util {
    ...
    public static boolean init(){        
        ...
        Util.FILE_LOG = ruta + "/logs/AppLog-" + DTAQ + "-" + Util.getFechaHoraActual("yyyyMMdd-HH-mm-ss") + ".log";        
